...
**We provided weights for ScaleFlow++ trained using GS58 in [Project](https://github.com/HanLingsgjk/CSCV) Readers can reproduce the effect in Table V of the paper SAG by downloading Demo_Scaleflowpp.pth**
